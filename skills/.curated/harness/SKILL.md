...
- [DeepSeek Harness（dsh）Plugin 开发](references/dsh-dev.md)：插件系统具体结构与开发主入口——Plugin / Context / Fiber、module / Loader entry / package、Bundle / Profile / Agent preset、配置合成与加载路径，以及临时原型、源码工程、Tool / Provider / 协议 / Web / Session 扩展、分层验证、打包安装和版本维护。
